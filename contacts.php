            ...
            <div class="contents-1">
                ...
                <div class="share-card">
                    <div class="contacts-card">
                        <h2 class="text-2xl font-bold mb-4">Contactez UB Médias</h2>
                        <center>
                            <div style="text-align: left;">
                                ...
                                <p class="mb-2">Chez <strong class="text-pr">UB Médias</strong>, la qualité de
                                    l’expérience client est
                                    au cœur de notre engagement. Que vous soyez un partenaire existant, un nouveau
                                    client ou simplement intéressé par notre activité, nous sommes heureux d’échanger
                                    avec vous.</p>
                            </div>
                            ...
                            <div style="text-align: left;">
                                ...
                                <br>
                                <h3 class="text-xl font-semibold mt-6 mb-2">Heures d’ouverture</h3>
                                <ul class="space-y-1">
                                    <li>Lundi à Vendredi : <span class="text-pr">08h00 – 17h00</span></li>
                                    <li>Samedi : <span class="text-pr">09h00 – 16h00</span></li>
                                    <li>Dimanche & jours fériés : <span class="text-pr">Fermé</span></li>
                                </ul>
                            </div>
                        </center>
                    </div>
