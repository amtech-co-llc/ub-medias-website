    ...
    <div class="container">
        ...
        <div class="body-contents">
            ...
            <div class="contents-1">
                ...
                <div class="other-cards" style="margin-top: -30px;">
                    ...
                    <div class="cards" id="items-container">
                        ...
                        <div class="card1">
                            ...
                            <div class="details">
                                <div class="categorie" id="categorie"><i class="ri-delete-back-line"></i> video title is
                                    here
                                </div>
                                <a href="#">
                                    <p class="article-content">Netanyahu tells Macron that establishment of Palestinian
                                        state will ‘reward’
                                        terrorism...
                                    </p><button class="button-2" style="margin-top:8px;">Voir la vidéo</button>
                                </a>
                            </div>
                        </div>
                        <!-- end of card1 -->
                            ...
                            <div class="details">
                                ...
                                <a href="#">
                                    <p class="article-content">Netanyahu tells Macron that establishment of Palestinian
                                        state will ‘reward’
                                        terrorism...</p>
                                    <button class="button-2" style="margin-top:8px;">Voir la vidéo</button>
                                </a>
                            </div>
                        </div>
                        <!-- end of card1 -->
