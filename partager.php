            ...
            <div class="contents-1">
                ...
                <div class="share-card">
                    ...
                    <div class="socials-icons-share">
                        <a href="https://wa.me/?text=<?php echo $desc . ' Lisez plus en clickant sur ce lien:' . "%0A%0Ahttp://192.168.0.199/ub-meidas/" . $result['seo_url'] ?>"><button><i class="ri-whatsapp-line"></i></button></a>
                        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo "http://192.168.0.199/ub-meidas/" . $result['seo_url'] ?>"><button><i class="ri-facebook-fill"></i></button></a>
                        <a href="https://twitter.com/intent/tweet?text=<?php echo $desc . ' Lisez plus en clickant sur ce lien:' . '%0A' . 'http://192.168.0.199/ub-meidas/' . $result['seo_url'] ?>"><button><i class="ri-twitter-x-line"></i></button></a>
                    </div>
                </div>
