    ...
    <div class="container">
        ...
        <div class="body-contents">
            ...
            <div class="contents-1">
                ...
                $sql = "SELECT * FROM publication WHERE `categorie` = 'sport' ORDER BY id DESC LIMIT 1";
                ...
                <div class="other-cards">
                    ...
                    <div class="cards" id="items-container">
                        ...
                        $sql = "SELECT * FROM publication WHERE `categorie` = 'sport' AND id != (SELECT MAX(id) FROM publication WHERE categorie = 'sport') ORDER BY RAND()";
                        $query = $pdo->prepare($sql);
                        $query->execute();
